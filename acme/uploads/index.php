    ...
    switch ($action) {
        case 'upload':
            ...
            if($imageCheck){
                ...
                $message = '<p class="message3">You must select a product and image file for the product.</p>';
            } else {
            ...
            if ($result) {
                $message = '<p class="message3">The upload succeeded.</p>';
            } else {
                $message = '<p class="message3">Sorry, the upload failed.</p>';
            }
            }
